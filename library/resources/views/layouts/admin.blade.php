      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          <div class="notification">
            ...
            @if(count($lateTransactions) > 0)
                <div class="alert alert-danger">
                    <p>Daftar Peminjaman yang Telat:</p>
                    <ul>
                        @foreach($lateTransactions as $transaction)
                            <li>{{ $transaction->id }} - {{ $transaction->date_end }}</li>
                        @endforeach
                    </ul>
                </div>
            @endif
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="{{ url('home') }}" class="nav-link {{ request()->is('home') ? '' : 'collapsed' }}">
          ...
          <li class="nav-item">
            <a href="{{  url('books')  }}" class="nav-link {{ request()->is('books') ? '' : 'collapsed' }}">
