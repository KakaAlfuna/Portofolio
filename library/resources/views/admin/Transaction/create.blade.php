    ...
    <form method="POST" action="{{ url('transactions') }}">
        ...
        <div class="card-body">
            <div class="form-group">
                ...
                <input type="date" name="date_start" class="form-control" id="date_start" placeholder="Masukkan Tanggal Pinjam">
                @error('date_start')
                    <div class="alert alert-danger">{{ $message }}</div>
                @enderror
                <label for="date_end">Tanggal Kembali</label>
                <input type="date" name="date_end" class="form-control" id="date_end" placeholder="Masukkan Tanggal Kembali">
                @error('date_end')
                    <div class="alert alert-danger">{{ $message }}</div>
                @enderror
